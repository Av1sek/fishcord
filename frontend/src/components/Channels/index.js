...
function ChannelsIndex() {
    ...
    .map(channel => 
        <div className="channel-list-item" key={channel.id + "/channelId" + Math.random()}>
            ...
            <div className="channel-tag-gear-container">
                <div className="channel-tag-gear">
                    <svg aria-hidden='true' role='img' className="svg-22-gear" onClick={() => {history.push(`/channels/${channel.id}/edit`)}}>
        ...
        return(
            <div className="channel-index">
                ...
                <div className="channel-category">
                    ...
                    <div className="channel-category-create" onClick={handleOpenModal}> 
